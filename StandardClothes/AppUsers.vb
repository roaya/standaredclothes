Public Class AppUsers
    ...
    Dim tbl2 As New GeneralDataSet.Security_Group_HeaderDataTable
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cls.RefreshData("select * from security_group_header", tbl2)
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceApp_Users, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click, MenuSave.Click
        Try
            ...
            ElseIf EmployeeID.Text = "" Or GroupID.Text = "" Then
                cls.MsgComplete()
            Else
                Gcls.SaveRecord()
            End If
    ...
    Private Sub TxtPassword_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtPassword.GotFocus
        TxtPassword.BackColor = Color.FromArgb(135, 180, 209)
    End Sub

    Private Sub SubTxtPassword_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtPassword.Leave
