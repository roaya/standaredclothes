Public Class ItemTypes
    ...
    Dim BSourceItems_Types As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Items_Types"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceItems_Types, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
            '-------------------------------
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceItems_Types, "Type_Name")
            TypeColor.TextBox1.DataBindings.Add("Text", BSourceItems_Types, "Type_Color")
            Model.TextBox1.DataBindings.Add("Text", BSourceItems_Types, "Model")
            FromCountry.TextBox1.DataBindings.Add("Text", BSourceItems_Types, "From_Country")
            RawMaterial.TextBox1.DataBindings.Add("Text", BSourceItems_Types, "Raw_Material")

            SSource = BSourceItems_Types
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceItems_Types, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceItems_Types.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
