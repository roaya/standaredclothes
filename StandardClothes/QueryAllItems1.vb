...
#Region "DataMethods"
    ...
    Private Sub DataLoad()
        ...
        Do While Not dr.Read = False
            cmbItemID.Items.Add(dr("Corporation_Name"))
        Loop
        dr.Close()
    End Sub
...
#End Region
    ...
    Private Sub choseForm()
        selformula = ""
        If cmbItemID.SelectedIndex <> -1 Then
            selformula = "select Category_Name AS 'اسم البند',Item_Name AS 'اسم الصنف',Stock_Name AS 'اسم المحل',Purchase_Price AS 'سعر الشراء',Sale_Price AS 'سعر البيع',Sale_Total_Price AS 'سعر الجملة', Corporation_Name AS 'اسم الشركة',Gender_Name AS 'النوع',From_Age AS 'من سن',To_Age AS 'الي سن',Size_Name AS 'المقاس' FROM Query_All_Items where Corporation_Name=N'" & (cmbItemID.Text) & "'"
