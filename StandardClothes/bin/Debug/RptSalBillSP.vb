...
Public Class RptSalBillSP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "StandardClothes.RptSalBillSP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSalBillSP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalBillSP = New RptSalBillSP()
        rpt.Site = Me.Site
        Return rpt
    End Function
