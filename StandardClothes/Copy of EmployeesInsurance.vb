Public Class EmployeesInsurance

    Dim Gcls As GeneralSp.NewMasterForms
    Dim B_EndLoad As Boolean = False
    Dim BsourceOwnerShip_Type As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "OwnerShip_Type"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BsourceOwnerShip_Type, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords)

            '-------------------------------
            'Must Specify Window Title 
            '-------------------------------

            Gcls.SetWTitle = "»Ì«‰«  ‰Ê⁄ «·„·ﬂÌÂ"
            Me.Text = Gcls.SetWTitle

            MasterField1.TextBox1.DataBindings.Add("Text", BsourceOwnerShip_Type, "Owner_Type_Name")
            GenericDesc.TextBox1.DataBindings.Add("Text", BsourceOwnerShip_Type, "Generic_desc")


            SSource = BsourceOwnerShip_Type

            '-------------------------------
            'Must Specify search field
            '-------------------------------

            RVal = "Owner_Type_Name"
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BsourceOwnerShip_Type, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BsourceOwnerShip_Type.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
    ...
    Private Sub type_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
