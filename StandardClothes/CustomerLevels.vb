Public Class CustomerLevels
    ...
    Dim BSourceCustomer_Levels As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Customer_Levels"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceCustomer_Levels, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceCustomer_Levels, "Level_Name")
            MaxCreditLimit.DataBindings.Add("Value", BSourceCustomer_Levels, "Max_Credit_Limit")

            SSource = BSourceCustomer_Levels
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceCustomer_Levels, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceCustomer_Levels.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        m.ShowDialog()
    End Sub
    Private Sub MaxCreditLimit_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxCreditLimit.GotFocus
        MaxCreditLimit.BackColor = Color.FromArgb(135, 180, 209)
    End Sub

    Private Sub MaxCreditLimit_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxCreditLimit.Leave
        MaxCreditLimit.BackColor = Color.White
    End Sub
End Class
