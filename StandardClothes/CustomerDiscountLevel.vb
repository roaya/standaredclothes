Public Class CustomerDiscountLevel

    Dim Gcls As GeneralSp.NewMasterForms
    Dim B_EndLoad As Boolean = False
    Dim BSourceCustomer_Discount_Level As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Customer_Discount_Level"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceCustomer_Discount_Level, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceCustomer_Discount_Level, "Level_Name")
            MaxDiscountCash.DataBindings.Add("Value", BSourceCustomer_Discount_Level, "Max_Discount_Cash")
            MaxDiscountPercent.DataBindings.Add("Value", BSourceCustomer_Discount_Level, "Max_Discount_Percent")

            SSource = BSourceCustomer_Discount_Level
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click, MenuSave.Click
        Try
            ...
            ElseIf MaxDiscountPercent.Value = 0 Then
                cls.MsgComplete()
                MaxDiscountPercent.Focus()
                MaxDiscountPercent.BackColor = Color.Red

            ElseIf MaxDiscountCash.Value = 0 Then

                cls.MsgComplete()
                MaxDiscountCash.Focus()
                MaxDiscountCash.BackColor = Color.Red
            Else
                Gcls.SaveRecord()
            End If
        Catch ex As Exception
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceCustomer_Discount_Level, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceCustomer_Discount_Level.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        m.ShowDialog()
    End Sub
    Private Sub MaxDiscountPercent_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxDiscountPercent.GotFocus
        MaxDiscountPercent.BackColor = Color.FromArgb(135, 180, 209)
    End Sub

    Private Sub MaxDiscountPercent_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxDiscountPercent.Leave
        MaxDiscountPercent.BackColor = Color.White
    End Sub
    Private Sub MaxDiscountCash_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxDiscountCash.GotFocus
        MaxDiscountCash.BackColor = Color.FromArgb(135, 180, 209)
    End Sub

    Private Sub MaxDiscountCash_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles MaxDiscountCash.Leave
        MaxDiscountCash.BackColor = Color.White
    End Sub
