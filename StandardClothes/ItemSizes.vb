Public Class ItemSizes
    ...
    Dim BSourceItem_Sizes As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Item_Sizes"
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            MasterField1.TextBox1.MaxLength = 25
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceItem_Sizes, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
            '-------------------------------
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceItem_Sizes, "Size_Name")
            GenericDesc.TextBox1.DataBindings.Add("Text", BSourceItem_Sizes, "Generic_Desc")

            SSource = BSourceItem_Sizes
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceItem_Sizes, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    ...
    Private Sub BtnCancelSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelSerach.Click
        Try
            BSourceItem_Sizes.RemoveFilter()
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
    End Sub
