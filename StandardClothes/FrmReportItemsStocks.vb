Public Class frmreportitemsstocks
    ...
    Dim RptCustRet As New RptItemsStocks
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If ByItem.Checked = True Then
                ...
                MyDs.Tables("report_items_Stocks").Rows.Clear()
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo from report_items_Stocks where item_id = " & Item.SelectedValue
                da.SelectCommand = cmd
                da.Fill(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetDataSource(MyDs.Tables("report_items_Stocks"))
            ...
            ElseIf bystock.Checked = True Then
                ...
                MyDs.Tables("report_items_Stocks").Rows.Clear()
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo from report_items_Stocks where stock_id = " & Stock.SelectedValue
                da.SelectCommand = cmd
                da.Fill(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetDataSource(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetParameterValue("P_HeaderReport", MyDs.Tables("App_Preferences").Rows(0).Item("P_HeaderReport"))
            ...
            ElseIf bycat.Checked = True Then
                ...
                MyDs.Tables("report_items_Stocks").Rows.Clear()
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo from report_items_Stocks where category_id = " & Category.SelectedValue
                da.SelectCommand = cmd
                da.Fill(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetDataSource(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetParameterValue("P_HeaderReport", MyDs.Tables("App_Preferences").Rows(0).Item("P_HeaderReport"))
            ...
            ElseIf bycorporation.Checked = True Then
                ...
                MyDs.Tables("report_items_Stocks").Rows.Clear()
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo from report_items_Stocks where corporation_id = " & Corporation.SelectedValue
                da.SelectCommand = cmd
                da.Fill(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetDataSource(MyDs.Tables("report_items_Stocks"))
                RptCustRet.SetParameterValue("P_HeaderReport", MyDs.Tables("App_Preferences").Rows(0).Item("P_HeaderReport"))
